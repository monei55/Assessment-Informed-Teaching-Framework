...
export function CoachLensNav() {
  return (
    <aside
      className="teacher-lens-nav coach-lens-nav"
      aria-label="Coach and middle leader lens navigation"
    >
      <div className="teacher-lens-nav-inner">
        <p className="teacher-lens-nav-eyebrow">
          Coach / Middle Leader Lens
        </p>
        ...
        <nav className="teacher-lens-nav-links">
          {coachLensSections.map((section, index) => (
